    ...
    >
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-[60px]">
        ...
        <div className="flex items-center justify-center gap-2 md:gap-3 mt-6 md:mt-8">
          <div
            className="w-16 h-16 sm:w-20 sm:h-20 md:w-[91px] md:h-[91px] bg-[#F5F5F5] rounded-[14px] flex flex-col items-center justify-center"
          >
          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="flex gap-5">
                ...
                <div className="relative w-[130px] h-[130px] bg-[#F9F9F9] rounded-2xl flex items-center justify-center shrink-0 overflow-hidden">
                ...
                <div className="flex flex-col justify-center gap-2">
                  <Link href={`/products/${product.slug}`}>
                    <h3 className="text-xl md:text-[24px] font-bold leading-[1.1] text-black pr-2 hover:text-[#E85A4F] transition-colors">
                      {product.name}
                    </h3>
                  </Link>
                  <div className="flex items-center gap-2.5 flex-wrap mt-1">
                    ...
                    {product.discount && (
                      <span className="bg-[#FDE7EA] text-[#D46B7A] px-2.5 py-1 rounded-md text-sm md:text-[15px] font-extrabold leading-none">
                        {product.discount}
                      </span>
                    )}
                  </div>
              ...
              <div className="flex items-center justify-between mt-auto pt-2">
                <motion.button
                  ...
                  className="w-[50px] h-[50px] rounded-[10px] bg-[#F9F9F9] flex items-center justify-center hover:bg-gray-100 transition-colors shrink-0"
                  aria-label="Add to wishlist"
                >
                  <Heart
                    className={`w-[22px] h-[22px] ${
                      isFavorite(product.id) ? "text-[#D46B7A] fill-[#D46B7A]" : "text-black"
                    }`}
                    strokeWidth={1.5}
                  />
                </motion.button>
                <motion.button
                  ...
                  className="bg-[#000000] text-white px-8 h-[50px] rounded-[8px] font-medium text-[26px] leading-[120%] tracking-normal hover:bg-gray-800 transition-colors w-full ml-4 flex items-center justify-center"
