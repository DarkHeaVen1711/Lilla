      ...
      <div className="relative w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center px-5 md:px-10 lg:px-[60px]">
        ...
        <div className="w-full lg:w-[25%] flex flex-col items-center text-center lg:items-start lg:text-left z-10 shrink-0">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="bg-[#000000] text-white hover:bg-gray-800 transition-colors shadow-lg flex items-center justify-center px-6 md:px-8 h-[44px] md:h-[48px] rounded-[8px] mt-6 md:mt-8 transform-gpu"
            
          >
            <span className="font-medium text-xl md:text-[26px] leading-[120%] tracking-normal flex items-center justify-center whitespace-nowrap">
              View All
            </span>
          </motion.button>
        </div>
              ...
              <SwiperSlide key={product.id}>
                <div className="flex flex-col gap-4 group cursor-pointer">
                  ...
                  <div className="relative w-full aspect-square bg-[#F4F4F4] rounded-[24px] overflow-hidden flex items-center justify-center p-6 transition-colors duration-300">
                    ...
                    <Link href={`/products/${product.slug}`} className="relative w-[80%] h-[80%] flex items-center justify-center cursor-pointer block">
                      <Image
                        src={product.image}
                        alt={product.name}
                        fill
                  ...
                  <div className="flex flex-col gap-1 px-1">
                    <Link href={`/products/${product.slug}`}>
                      <h3 className="text-[16px] font-medium text-black leading-tight hover:text-[#E85A4F] transition-colors">
                        {product.name}
                      </h3>
                    </Link>
