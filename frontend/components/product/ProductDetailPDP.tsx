...
export function ProductDetailPDP({ product: initialProduct, recommendedProducts }: ProductDetailPDPProps) {
  ...
  return (
    <div className="w-full bg-white font-sans text-black antialiased">
      ...
      <div className="w-full bg-[#FAFAFA] py-4 border-b border-gray-100 mt-[80px]">
        <div className="max-w-[1440px] mx-auto px-5 text-center sm:text-left text-sm md:text-base tracking-wide text-gray-500 uppercase font-semibold">
      ...
      <section className="max-w-[1440px] mx-auto px-5 py-10 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 xl:gap-16 items-start">
          ...
          <div className="flex flex-col md:flex-row gap-5">
            ...
            <div className="flex md:flex-col gap-3 order-2 md:order-1 overflow-x-auto md:overflow-x-visible md:overflow-y-auto max-h-[100px] md:max-h-[550px] shrink-0 pb-2 md:pb-0 scrollbar-none">
              {thumbnails.map((thumb, idx) => (
                <button
                  ...
                  className={`relative w-20 h-20 md:w-28 md:h-28 bg-[#faf7f4] rounded-2xl overflow-hidden border-2 transition-all shrink-0 ${
            ...
            <div className="flex-1 relative aspect-square bg-[#faf7f4] rounded-[24px] md:rounded-[32px] overflow-hidden border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.02)] order-1 md:order-2 group cursor-zoom-in">
              <Swiper
                ...
                {thumbnails.map((thumb, idx) => (
                  <SwiperSlide key={idx} className="relative w-full h-full" onClick={() => setIsMainLightboxOpen(true)}>
                    <Image
                      ...
                      fill
                      priority={idx === 0}
                      className="object-contain p-6 md:p-12 transition-transform duration-500 group-hover:scale-105"
                    />
                  </SwiperSlide>
                ))}
              </Swiper>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-normal font-serif leading-[1.1] mb-3">
                {product.name}
              </h1>
              ...
              <div className="flex items-center gap-5">
                ...
                {product.originalPrice && (
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="bg-[#E85A4F]/10 text-[#E85A4F] px-2.5 py-1 rounded text-sm font-bold uppercase tracking-wider">
                      {product.discount || "Sale"}
                    </span>
                  </div>
                )}
              </div>
              <div className="flex items-center gap-2 bg-[#FAFAFA] border border-gray-100 px-4 py-2 rounded-full shadow-sm">
            ...
            <div className="flex flex-col gap-4 text-lg md:text-xl text-gray-700 font-medium leading-relaxed bg-[#FAFAFA] p-6 rounded-[24px] border border-gray-100">
              <div className="flex items-center gap-2 text-base md:text-lg font-extrabold text-[#E85A4F] mb-1">
                <span className="w-2.5 h-2.5 rounded-full bg-[#E85A4F] animate-pulse"></span>
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className={`w-[56px] h-[56px] flex items-center justify-center rounded-full border transition-all ${
                    favorite ? "border-[#D46B7A] bg-[#D46B7A]/5 text-[#D46B7A] scale-95" : "border-gray-200 hover:border-black text-gray-500 hover:text-black"
                  }`}
                ...
                {isEditingZip ? (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="text-sm font-bold text-[#E85A4F] hover:underline"
                    >
                      Change
                    </button>
                  </div>
      ...
      {product.features && product.features.length >= 3 && (
        ...
        >
          {/* Left-aligned Title */}
          <div className="mb-12">
            <h2 className="text-[56px] font-normal font-serif text-[#111111] leading-none">About the Product</h2>
          </div>
      ...
      <section className="max-w-[1440px] mx-auto px-5 py-16 border-b border-gray-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 items-start">
          ...
          <div className="flex flex-col gap-8 bg-[#FAFAFA] p-8 rounded-[32px] border border-gray-100 shadow-sm">
      ...
      <section className="max-w-[1440px] mx-auto px-5 py-16 overflow-hidden relative">
        {/* Blush Smudge Decoration */}
        <div className="absolute w-[439.86px] h-[321.76px] left-[1186px] top-[150px] rotate-[50.73deg] opacity-100 pointer-events-none z-0">
          <Image src={imgYoumightlikeBlush} alt="Blush Smudge" className="object-contain" fill />
        </div>

        <div className="flex items-center justify-between mb-8 relative z-10">
          <h2 className="text-5xl font-normal font-serif">You might like</h2>
            ...
            {recommendedProducts.map((prod) => (
              <SwiperSlide key={prod.id}>
                <div className="flex flex-col gap-4 group cursor-pointer">
                  {/* Image Container */}
                  <div className="relative w-full aspect-square bg-[#F4F4F4] rounded-[24px] overflow-hidden flex items-center justify-center p-6 transition-colors duration-300">
                    {/* Discount Badge inside top-left */}
                    {prod.discount && (
                      <div className="absolute top-4 left-4 z-10 bg-[#FDE7EA] text-[#D46B7A] px-3 py-1 rounded-full text-xs font-bold shadow-sm">
                        {prod.discount}
                      </div>
                    )}
                    ...
                    <Link href={`/products/${prod.slug}`} className="relative w-[80%] h-[80%] flex items-center justify-center cursor-pointer block">
                      <Image
                        src={prod.image}
                        alt={prod.name}
                        fill
                  ...
                  <div className="flex flex-col gap-1 px-1">
                    <Link href={`/products/${prod.slug}`}>
                      <h3 className="text-[16px] font-medium text-black leading-tight hover:text-[#E85A4F] transition-colors line-clamp-2 min-h-[44px]">
                        {prod.name}
                      </h3>
                    </Link>
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      {prod.discount && (
                        <span className="bg-[#FDE7EA] text-[#D46B7A] px-2.5 py-0.5 rounded-full text-[13px] font-bold">
                          {prod.discount}
                        </span>
                      )}
                    </div>
      ...
      {lightboxImage && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100] p-4 backdrop-blur-sm">
          <div className="relative bg-white rounded-3xl overflow-hidden max-w-[900px] w-full grid grid-cols-1 md:grid-cols-2 shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            {/* Left Side: Photo */}
            <div className="relative aspect-square w-full bg-[#f8f7f4] md:h-full">
