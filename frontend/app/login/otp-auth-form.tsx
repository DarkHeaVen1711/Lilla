          ...
          >
            ...
            <form onSubmit={handleSendOtp} className="flex flex-col gap-5">
              ...
              <button
                ...
                className="mt-6 w-full h-[52px] flex items-center justify-center text-white text-[16px] font-semibold transition-colors disabled:bg-[#BDBDBD] disabled:cursor-not-allowed bg-black hover:bg-gray-800"
              >
          ...
          >
            ...
            <form onSubmit={handleVerifyOtp} className="flex flex-col gap-6">
              ...
              <button
                ...
                className="mt-2 w-full h-[52px] flex items-center justify-center text-white text-[16px] font-semibold transition-colors disabled:bg-[#BDBDBD] disabled:cursor-not-allowed bg-black hover:bg-gray-800"
              >
